    ...
    <div class="pb-4 px-4 md:pb-8 md:px-8">
                    ...
                    <div class="flex gap-4">
                        ...
                        <button class="border grow border-neutral-300 p-5 rounded-2xl h-fit cursor-pointer"
                            ...
                            <div class="flex justify-between">
                                <div class="text-2xl font-semibold text-neutral-800">
                                    {{-- $complaintsToDisplay --}}
                                    {{ $complaintsToDisplay->whereBetween('created_at', [now()->startOfWeek(), now()->endOfWeek()])->count() }}
                                </div>
                                <div
                                ...
                                <div class="overflow-y-auto max-h-[55vh] mt-3">
                                    <table class="table text-neutral-800 table-auto md:table-md lg:table-lg">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($complaintsToDisplay->whereBetween('created_at', [now()->startOfWeek(), now()->endOfWeek()])->all() as $complaint)
                                                <tr class="hover:bg-base-200">
                                                    ...
                                                    <td class="flex flex-row justify-center md:gap-3 gap-1.5">
                                                        ...
                                                        <dialog id="view_modal_{{ $complaint->id }}" class="modal">
                                                            <div class="modal-box">
                                                                ...
                                                                <div class="card bg-base-100 w-full shadow-xl">
                                                                    <figure><img src="{{ asset('/images/first.png') }}"
                                                                            alt="Shoes" />
                                                                    </figure>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <script>
                                                                                document.addEventListener("DOMContentLoaded", () => {
                                                                                    const openCameraBtn = document.getElementById("openCamera3");
                                                                                    const switchCameraBtn = document.getElementById("switchCamera3");
                                                                                    const captureImageBtn = document.getElementById("captureImage3");
                                                                                    const closeCameraBtn = document.getElementById("closeCamera3");

                                                                                    const video = document.getElementById("video3");
                                                                                    const canvas = document.getElementById("canvas3");
                                                                                    const attachmentInput = document.getElementById("attachment3");
                                                                                    const captureControls = document.getElementById("captureControls3");
                                                        ...
                                                        {{-- DELETE BUTTON --}}
                                                        <form
                                                            action="{{ route('allComplaints.destroy', $complaint->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button
                                ...
                                <div class="mt-2 flex gap-4 justify-center align-center">
                                    <div
                                        ...
                                        <div class="flex flex-col items-center justify-center gap-1">
                                            ...
                                            <div class="text-2xl font-semibold text-neutral-800">
                                                {{-- $complaintsToDisplay --}}
                                                {{ $complaintsToDisplay->where('status', 'solved')->count() }}
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="flex flex-col items-center justify-center gap-1">
                                            ...
                                            <div class="text-2xl font-semibold text-neutral-800">
                                                {{-- $complaintsToDisplay --}}
                                                {{ $complaintsToDisplay->where('status', 'closed')->count() }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex gap-4 justify-center align-center mt-4">
                                    <div
                                        ...
                                        <div class="flex flex-col items-center justify-center gap-1">
                                            ...
                                            <div class="text-2xl font-semibold text-neutral-800">
                                                {{-- $complaintsToDisplay --}}
                                                {{ $complaintsToDisplay->where('status', 'processing')->count() }}
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="flex flex-col items-center justify-center gap-1">
                                            ...
                                            <div class="text-2xl font-semibold text-neutral-800">
                                                {{-- $complaintsToDisplay --}}
                                                {{ $complaintsToDisplay->where('status', 'pending')->count() }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="border border-gray-300 p-8 rounded-2xl mt-7">
            ...
            <div class="mb-5 flex justify-between items-center"
                {{ auth()->user()->email_verified_at ? 'hidden' : '' }}>
                <div role="alert" class="alert alert-warning w-fit">
                    <span class="font-semibold text-xl uppercase">Ask your barangay captain to verify your account so
                        you can add a complaint.</span>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between">
                <h1
                    ...
                    @if (auth()->user()->role == 'official' || auth()->user()->role == 'admin')
                        Lists of All Complaints
                    @else
                        Lists of Your Complaints
                    @endif
                </h1>
                ...
                <dialog id="my_modal_5" class="modal max-w-2xl mx-auto">
                    <div class="modal-box p-5 md:p-10">
                        ...
                        <div class="space-y-3">
                            ...
                            <form method="post" action="{{ url('/complaints/create') }}"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="flex flex-col w-full">
                                    ...
                                    <select name="category"
                                        class="select validator select-bordered text-neutral-800 w-full" required>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <textarea class="textarea validator w-full" type="text" name="description" value="{{ old('description') }}"
                                        required placeholder="Naglisod ug tulog kay banha ang videoke"></textarea>
                                    <div class="validator-hint text-[17px]">This field is required</div>
                                </div>
                    ...
                    <script>
                        setTimeout(function() {
                            ...
                            successMessage.className =
                                'fixed rounded-lg top-5 right-120 transform -translate-x-1/2 -translate-y-1/2 p-4 mt-8 mr-4 bg-secondary border border-none text-lg text-neutral-800 font-semibold rounded transition-opacity duration-1000 alert alert-success';
                    ...
                    <script>
                        setTimeout(function() {
                            ...
                            errorMessage.className =
                                'fixed rounded-lg top-5 right-120 transform -translate-x-1/2 -translate-y-1/2 p-4 mt-8 mr-4 bg-red-600 border border-none text-lg text-white font-semibold rounded transition-opacity duration-1000 alert alert-danger';
                    ...
                    <tbody>
                        ...
                        @php
                            ...
                            if (request('id') || request('category') || request('status') || request('date')) {
                                ...
                                $filteredComplaints = $complaintsToDisplay->filter(function ($complaint) {
                                    $matches = true;
                            ...
                            $sortedComplaints = $filteredComplaints
                                ->sortByDesc('status_priority')
                                ->sortByDesc('created_at');
                        @endphp

                        @foreach ($sortedComplaints as $key => $complaint)
                            <tr class="hover:bg-base-200">
